document.addEventListener('DOMContentLoaded', () => {
    ...
    async function getListaNome() {
        const response = await fetch(`https://microsservi-ovini-production.up.railway.app/api/listas/${listaId}`);
    ...
    tarefaForm.addEventListener('submit', async (e) => {
        ...
        await fetch('https://microsservi-ovini-production.up.railway.app/api/tarefas', {
            method: 'POST',
            headers: {
    ...
    async function loadTarefas() {
        const response = await fetch(`https://microsservi-ovini-production.up.railway.app/api/tarefas/lista/${listaId}`);
    ...
    window.deleteTarefa = async (id, listaId) => {
        await fetch(`https://microsservi-ovini-production.up.railway.app/api/tarefas/${id}`, {
            method: 'DELETE'
        });
        loadTarefas();
    };
